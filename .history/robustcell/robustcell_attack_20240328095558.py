...
class graphRobustCell(object):
    ...
    def fit_GCN(self, input_data, adj, label, idx_train):
        if adj == None:
            adj = self.adj
        device = self.device 
    ...
    def metaattack(self, surrogate, input_data, adj, label, idx_train):
        if adj == None:
            adj = self.adj
        features = input_data
    ...
    def DICEattack(self, surrogate, input_data, adj, label, idx_train)